...
export default function Home(){
 ...
 return <main>
  <div className="notice"><span>🍔</span> Fast Bites. Big Flavour. Every Craving, One Place. <a href="tel:+8801603365308">Call 01603 365 308</a></div>
    <header className="header wrap"><a href="#home" className="logo"><img src="/brand/logo.png" alt="Dhakaiya Bites logo"/><div><b>Dhakaiya Bites</b><small>GOOD FOOD • EVERY BITE</small></div></a><nav className="desktop-nav"><a href="#home">Home</a><button className="nav-menu-button" onClick={()=>showMenu(0)}>Menu</button><a href="#about">About</a><a href="#verify">Staff Verify</a><a href="#contact">Contact</a></nav><div className="header-actions"><Link className="btn btn-small" href="/order">Order <span>↗</span></Link><details className="mobile-menu"><summary aria-label="Open navigation"><span/><span/><span/></summary><div className="mobile-menu-panel"><a href="#home">Home</a><a href="/menu">Full Menu</a><a href="#about">About Us</a><a href="#verify">Staff Verification</a><a href="#contact">Contact</a></div></details></div></header>
